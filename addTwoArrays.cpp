...
// sum should not contain any leading zeros. Detailed explanation ( Input/output
// format, Notes, Images ) Constraints: 1 <= T <= 10^2 1 <= N, M <= 10^4 0 <=
// A[i], B[i] <= 9
//
// Time Limit: 1 sec
// Sample Input 1:
...
// For the first test case, the integer represented by the first array is 1234
// and the second array is 6, so the sum is 1234 + 6 =  1240.
//
// For the second test case, the integer represented by the first array is 123
// and the second array is 99, so the sum is 123 + 99 = 222. Sample Input 2:
// 2
// 3 3
// 4 5 1
// 3 4 5
